...
# print("checke doppelte bei: ", zahlen1)  # True
# print("checke doppelte bei: ", zahlen2)  # False
...
print("checke doppelte bei: ", pruefung_liste(zahlen1))  # True
print("checke doppelte bei: ", pruefung_liste(zahlen2))  # False